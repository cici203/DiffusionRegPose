...
def oks_overlaps(kpt_preds, kpt_gts, kpt_valids, kpt_areas, sigmas):
    ...
    # squared_distance = torch.abs(kpt_preds[:, :, 0] - kpt_gts[:, :, 0]) + \
    #                    torch.abs(kpt_preds[:, :, 1] - kpt_gts[:, :, 1])
    ...
    def __init__(self,
        ...
        if num_keypoints == 17:
            self.sigmas = np.array([
                ...
                1.07, .87, .87, .89, .89
            ], dtype=np.float32) / 10.0 # 17

            # self.sigmas = np.array([
            #     200, 200, 200, 200, 200, .79, .79, .72, .72, .62, .62, 1.07,
            #     1.07, .87, .87, .89, .89
            # ], dtype=np.float32) / 10.0  # 17
            #
            # self.sigmas = np.array([
            #     200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200
            # ], dtype=np.float32) / 2000.0  # 17
            # self.sigmas = np.array([
            #     .79, 0.01, 0.01, 0.01, 0.01, .79, 0.79, .72, .72, .62, .62, 1.07,
            #     1.07, .87, .87, .89, .89
            # ], dtype=np.float32) / 10.0 # 13
