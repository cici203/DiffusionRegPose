...
def build_backbone(args):
    ...
    if args.backbone in ['resnet50', 'resnet101']:
        ...
        pretrainedpath = '/root/autodl-tmp/model/edpose_swinl_crowdpose.pth'#
        # pretrainedpath = '/root/autodl-tmp/model/edpose_swinl_5scale_crowdpose.pth'
