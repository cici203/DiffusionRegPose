...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='crowdpose')  # coco or crowdpose  OCHuman
    ...
    parser.add_argument('--resume', default='', help='resume from checkpoint')# Q200
    #------------------------------------2025---------------------------------------#
    parser.add_argument('--pretrain_model_path', help='load from other checkpoint', required=True)
    ...
    parser.add_argument('--dist_url', default='env://1', help='url used to set up distributed training')
...
def main(args):
    ...
    if args.dataset_file == "coco":
        ...
        args.crowdpose_path = '/path/to/crowdpose'
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            logger=(logger if args.save_log else None), ema_m=ema_m, writer_dict=writer_dict)
        if args.output_dir:
